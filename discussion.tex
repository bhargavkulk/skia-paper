...
We thus changed our focus to develop the formalization,
...
Hence, one direction we plan to explore in the future
  ...
  for example, we could verify a compiler from SVG or HTML \texttt{<canvas>} to Skia or another back-end library.
