...
We then identify four patterns
  ...
  and write replacements for each pattern.
...
On \graphiteAppleNumBench Skia programs
  gathered from the top 100 websites,
  this optimizer yields a speedup of \graphiteAppleGeoSpeedup
  over Skia's most modern GPU backend,
  while taking just \graphiteAppleMaxOptTime for optimization.
